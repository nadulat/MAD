...
class FetchPropertyTenant  : AppCompatActivity() {
    ...
    private fun getPropertyData(){
        ...
        val fetch = dbRef.orderByChild("propTenant").equalTo(oId)
                ...
                if (snapshot.exists()){
                    ...
                    mAdapter.setOnItemClickListener(object: PropertyAdapter.onItemClickListener{
                        override fun onItemClick(position: Int) {
                            val intent = Intent(this@FetchPropertyTenant,  PropertyDetailsActivityTenant::class.java)
